resource "aws_launch_template" "app1_LT" {
  ...
  user_data = base64encode(<<-EOF
    ...
    <div>
    <h1>ECS</h1>
    <h1>EC Sayians Love the Kids</h1>
    ...
    <iframe src="https://giphy.com/embed/3otPoo8NDLOmzvTJF6" width="480" height="269" style="" frameBorder="0" class="giphy-embed" allowFullScreen></iframe><p><a href="https://giphy.com/gifs/nintendo-switch-mario-kart-8-deluxe-3otPoo8NDLOmzvTJF6">via GIPHY</a></p>
    </html>
    HTML
